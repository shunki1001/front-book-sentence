      ...
      <Box sx={{ width: '100%' }}>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={value} onChange={handleChange} centered>
            <Tab label="本棚" sx={{width:'50%'}} style={styles.MuiTabDisabled} value={0} {...a11yProps(0)} disabled />
            <Tab label="レポート" sx={{width:'50%' }} value={1} {...a11yProps(1)} />
          </Tabs>
        </Box>
        ...
        <TabPanel value={value} index={1}>
          <Box sx={{ display: 'flex' }}>
            {/* センテンス数 */}
            <Box sx={{border: '2px solid #707070', px: '8px',py:'16px', minWidth: '128px'}}>
